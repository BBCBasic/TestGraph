...
BASELINE_GUIDANCE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "text": (
            ...
            "mean the same thing, or about a belongs_to or other semantic relationship, may justify preserving "
            "separate concepts or opening a deliberation rather than silently collapsing them. Reuse stable types "
            "and aliases when they fit; otherwise reason broad-to-specific and add only the missing semantic nodes. "
            "Reviews are records, not leaf nodes in a storage taxonomy."
        ),
    },
    {
